...
app.config(function($translateProvider) {
    $translateProvider.translations('he', {
        ...
        AVL : 'נקודה פגיעה ניתנת לניצול באמצעות גישה מקומית, כלומר שהרכיב הפגיע לא מחובר לרשת, והנתיב של התוקף עובר דרך יכולות קריאה/כתיבה/ביצוע. במקרים מסוימים, התוקף יכול להיות מחוברת באופן מקומי על מנת לנצל את הנקודה הפגיעה, אחרת, התקיפה תסתמך על אינטראקציית משתמש על מנת לשגר קובץ זדוני. '
